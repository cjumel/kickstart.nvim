...
local function line_begin_function(line_to_cursor)
  local line_to_trigger = utils.get_line_to_trigger(line_to_cursor)
...
M.make_ts_node_in_condition = function(node_types)
  return ls_conds.make_condition(function(line_to_cursor)
    local is_treesitter_parsable_, node = pcall(utils.get_treesitter_node_at_trigger, line_to_cursor)
