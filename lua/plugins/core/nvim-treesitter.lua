    ...
    textobjects = {
      ...
      move = {
        ...
        goto_next_start = {
          ...
          ["[i"] = { query = "@conditional.outer", desc = "Next if statement start" },
        ...
        goto_next_end = {
          ...
          ["[I"] = { query = "@conditional.outer", desc = "Next if statement end" },
        ...
        goto_previous_start = {
          ...
          ["]i"] = { query = "@conditional.outer", desc = "Previous if statement start" },
        ...
        goto_previous_end = {
          ...
          ["]I"] = { query = "@conditional.outer", desc = "Previous if statement end" },
