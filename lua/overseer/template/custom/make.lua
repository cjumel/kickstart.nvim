-- Template provider directly adapted from
-- https://github.com/stevearc/overseer.nvim/blob/master/lua/overseer/template/make.lua

---@param opts overseer.SearchParams
---@return nil|string
local function get_makefile(opts) return vim.fs.find("Makefile", { upward = true, type = "file", path = opts.dir })[1] end

---@type overseer.TemplateFileProvider
return {
  cache_key = function(opts) return get_makefile(opts) end,
